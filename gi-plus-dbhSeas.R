...
ppt.data$AMJ <- ppt.data$X4 + ppt.data$X5 + ppt.data$X6
ppt.data$SO <- ppt.data$X9 + ppt.data$X10
tmn.data$AMJ <- tmn.data$X4 + tmn.data$X5 + tmn.data$X6
tmn.data$SO <- tmn.data$X9 + tmn.data$X10

ppt <- standardize(ppt)
tmn <- standardize(tmn)
ppt.AMJ <- standardize(ppt.data$AMJ)
ppt.SO <- standardize(ppt.data$SO)
tmn.AMJ <- standardize(tmn.data$AMJ)
tmn.SO <- standardize(tmn.SO)
