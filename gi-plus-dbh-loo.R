...
log_lik_gi_multi_size <- extract_log_lik(fit, parameter_name="log_lik_gi")
log_lik_dbh_multi_size <- extract_log_lik(fit, parameter_name="log_lik_dbh")
...
loo_multi_size <- loo(log_lik_gi_multi_size)
...
cat("\n\n")
cat("DBH component\n")
loo_multi_size <- loo(log_lik_dbh_multi_size)
